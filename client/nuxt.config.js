...
export default {
  ...
  apollo: {
    clientConfigs: {
      default: {
        httpEndpoint: 'http://localhost:3000/graphql', // Replace with your GraphQL server endpoint
      },
    },
  },
  ...
  modules: [
    ...
    '@nuxtjs/axios',
    '@nuxtjs/dotenv',
    '@nuxt/typescript-build', // Enable TypeScript support
  ],
  axios: {
